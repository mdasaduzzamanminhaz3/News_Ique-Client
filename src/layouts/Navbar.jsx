...
// page load এ localStorage থেকে mode load করা
  useEffect(() => {
  ...
  // darkMode change হলে documentElement এ add/remove করা
  useEffect(() => {
    if (darkMode) {
      document.documentElement.classList.add("dark");
    } else {
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center flex-grow max-w-md mx-4">
            ...
            />
            <button onClick={handleSearch} className="bg-blue-600 text-white px-3 py-2.5 rounded-r-md hover:bg-blue-700 cursor-pointer">
              <Search size={18} />
            </button>
          </div>
  ...
  >
    {item}
            ...
            <div className="flex items-center mt-3">
              ...
              />
              <button onClick={handleSearch} className="bg-blue-600 text-white px-3 py-2.5 rounded-r-md hover:bg-blue-700">
                <Search size={18} />
              </button>
            </div>
            ...
            <button
              onClick={toggleDarkMode}
              className="flex items-center gap-2 mt-3 bg-gray-100 dark:bg-gray-700 p-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600"
            >
              {darkMode ? <Sun size={18} /> : <Moon size={18} />}
